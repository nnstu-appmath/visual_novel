...
define gui.about = _p("""Игра о главном герое Грише, который проходит обучение
в Унитехе, где взаимодействует со своими одногруппниками и
делает выборы, влияющие на дальнейшие события.
...
системы" студентками групп 19-ПМ: Балиной Марией, Догадиной Ириной и Котовой
Дарьей с помощью Ren'Py.
""")
