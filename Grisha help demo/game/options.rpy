...
define config.name = _("Гриша, помоги! (демо)")
...
define gui.about = _p("""Игра об обычном парне Грише, на месте которого мог
оказаться каждый из вас. Он учится в Унитехе, где взаимодействует со своими
одногруппниками и делает выборы, влияющие на дальнейшие события.

Все совпадения с реальными людьми и событиями случайны

Игра сделана в рамках курсового проекта по дисциплине "Распределенные вычислительные
системы" студентками групп 19-ПМ НГТУ им. Р.Е. Алексеева: Балиной Марией,
Догадиной Ириной и Котовой Дарьей с помощью Ren'Py.
""")
...
define build.name = "Grisha-help-demo"
...
define config.main_menu_music = "/music/main.mp3"
...
define config.save_directory = "Grishahelp-1665506287"
