...
define config.name = _("Статистическая игра")
...
define gui.about = _p("""Визуализация статистической игры с дверьми

Игра сделана в рамках курсового проекта по дисциплине "Теория игр и
исследования операция" студентками групп 19-ПМ НГТУ им. Р.Е. Алексеева: 
Балиной Марией, Догадиной Ириной и Котовой Дарьей с помощью Ren'Py.
""")
...
define build.name = "Statistic-game"
...
define config.save_directory = "Statistic-game"
